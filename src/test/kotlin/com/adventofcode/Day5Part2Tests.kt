...
import com.adventofcode.Day5Part2.*
...
. . . 1 .""".trim())
    ...
    fun testMultipleLinesDangerZoneCount() {
        ...
        grid.add(Line(Coordinate(3, 0), Coordinate(3, 4)))
        grid.add(Line(Coordinate(1, 1), Coordinate(3, 3)))
        assertThat(grid.numberOfDangerZones()).isEqualTo(6)
    }
    ...
    @Test
    fun testParse() {
        val lines: List<Line> = Day5Part2.parse("1,1 -> 444,100")
    ...
    fun testSolvePuzzle() {
        ...
        val result = Day5Part2.eval(string)
        assertThat(result).isEqualTo(18423)
    }
}
